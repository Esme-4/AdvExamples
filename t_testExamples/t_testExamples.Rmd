...
set.seed(123)We start this example estimating a parametric t-test, from rstatix, to use the same data format for the non-parametric test. Then we run the Wilconxon test from rstatix. Finally, in the robust statistical estimates section we use a yuen test and other examples.
