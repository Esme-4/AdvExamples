...
Hyper_t_test <- Hyper_n %>% t_test(Cholesterol ~ Group, p.adjust.method = "holm", paired = FALSE, alternative = "less", conf.level = 0.95) %>% add_significance()

Hyper_t_test

# And the non-parametric example
Hyper_wilcox <- Hyper_n %>% wilcox_test(Cholesterol ~ Group, p.adjust.method = "holm", paired = FALSE, alternative = "less", conf.level = 0.95) %>% add_significance()
