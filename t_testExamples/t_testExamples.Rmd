...
### "Nice graphics"  
No lets use an interesting R package that produces quite interesting graphics `ggstatsplot` we will make more examples of this package to solve ANOVA examples.
...
t.test(MaxPain ~ Treatment, data = MaxPain_new_long, alternative = "less", paired = TRUE, var.equal = TRUE, conf.level = 0.95)
