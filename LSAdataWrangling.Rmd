...
# Permutation  
Finally we do a different test, a permutation estimation for the effect size using a conditional inference procedure. For this example the test function is he `oneway_test` from de `coin` library.
