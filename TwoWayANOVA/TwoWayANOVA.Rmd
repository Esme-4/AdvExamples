...
From the interaction plot we can see that the difference between the Ve1-SMOKE3 and the Ve2-SMOKE2, and the variables Ve and SMOKE appear to have no effect on the variable HRV.  
